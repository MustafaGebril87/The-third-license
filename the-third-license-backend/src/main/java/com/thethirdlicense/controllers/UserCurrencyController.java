...
public class UserCurrencyController {
    ...
    public ResponseEntity<String> withdraw(@AuthenticationPrincipal UserPrincipal user, @RequestBody WithdrawRequest request) {
    ...
    public ResponseEntity<String> transferCurrency(@AuthenticationPrincipal UserPrincipal sender, @RequestBody TransferRequest request) {
