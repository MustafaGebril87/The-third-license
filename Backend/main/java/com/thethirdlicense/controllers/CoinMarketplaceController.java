...
import com.thethirdlicense.models.CurrencyToken;
...
import com.thethirdlicense.services.PayPalService;
...
public class CoinMarketplaceController {
    ...
    public ResponseEntity<?> initiatePurchase(@RequestParam UUID offerId,
        ...
        try {
            PayPalCreateOrderResponse approvalUrl = payPalService.createOrder(
                total,
    ...
    @PostMapping("/confirm")
    public ResponseEntity<?> confirmPurchase(@RequestParam String orderId,
